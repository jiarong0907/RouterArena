...
class ModelInference:
    ...
    def infer(self, model_name: str, prompt: str, max_retries: int = 3) -> Dict[str, Any]:
        """
    ...
    def _call_replicate(self, model_name: str, prompt: str) -> Dict[str, Any]:
        ...
        if model_name == "meta/codellama-34b-instruct":
            model_name += ":eeb928567781f4e90d2aba57a51baef235de53f907c214a4ab42adabf5bb9736"
    ...
    def _call_together(self, model_name: str, prompt: str) -> Dict[str, Any]:
        ...
        clean_model_name = model_name.replace("togetherai/", "").replace("together/", "")
...
"""
        ...
        try:
            ...
            input_tokens = int(response_headers.get("x-amzn-bedrock-input-token-count", 0))
            output_tokens = int(response_headers.get("x-amzn-bedrock-output-token-count", 0))
            total_tokens = input_tokens + output_tokens
